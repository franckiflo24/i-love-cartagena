  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.p}>{tr('La plataforma es operada por Amo Cartagena S.A.S., con domicilio en Cartagena de Indias, Colombia. Contacto: soporte@amocartagena.app')}</Text>
        ...
        <Text style={styles.p}>{tr('Todo el contenido propio de la app (código, diseño, marca "Amo Cartagena", textos, ilustraciones) es propiedad de Amo Cartagena S.A.S. Las fotografías y marcas de partners pertenecen a sus respectivos titulares y se muestran bajo licencia o autorización.')}</Text>
        ...
        <Text style={styles.h1}>{tr('12. Contacto')}</Text>
        <Text style={styles.p}>{tr('Para cualquier duda o reclamo escribe a soporte@amocartagena.app o usa el formulario de ayuda dentro de la app (Perfil → Ayuda).')}</Text>
