  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.h1}>{tr('1. Bienvenido a AMO Life')}</Text>
        <Text style={styles.p}>{tr('AMO Life es una aplicación móvil que conecta visitantes con la oferta cultural, gastronómica y de hospitalidad de Cartagena de Indias, Colombia. Al usar la app aceptas estos Términos. Si no estás de acuerdo, no uses el servicio.')}</Text>
