    ...
    try {
      ...
      if (!hasResults) {
        ...
        const SYNONYMS: Record<string, string[]> = {
          ...
          'frances': ['french', 'francesa', 'bistro'], 'francesa': ['french', 'bistro'],
          'espanol': ['spanish', 'espanola', 'tapas', 'paella'], 'espanola': ['spanish', 'tapas'],
          'tapas': ['spanish', 'espanola'], 'paella': ['spanish', 'espanola'],
          'vegano': ['healthy', 'vegetarian', 'vegetariano', 'vegan', 'saludable'],
          'vegana': ['healthy', 'vegetarian', 'vegan'], 'vegan': ['healthy', 'vegetarian'],
          'vegetariano': ['healthy', 'vegetarian'], 'vegetariana': ['healthy', 'vegetarian'],
          'mariscos': ['seafood', 'pescado', 'ceviche'], 'seafood': ['mariscos', 'pescado'],
          'pescado': ['seafood', 'mariscos'], 'ceviche': ['seafood', 'cevicheria', 'peruana'],
          'mexicano': ['mexican', 'mexicana', 'tacos'], 'mexicana': ['mexican', 'tacos'], 'tacos': ['mexican', 'mexicana'],
          'peruano': ['peruvian', 'peruana', 'ceviche', 'nikkei'], 'peruana': ['peruvian', 'ceviche', 'nikkei'],
          'arabe': ['middle_eastern', 'libanesa', 'shawarma'], 'shawarma': ['middle_eastern', 'arabe'], 'libanes': ['middle_eastern', 'arabe'],
          'carnes': ['grill', 'parrilla', 'steak', 'steakhouse'], 'steak': ['grill', 'carnes', 'parrilla'],
          'parrilla': ['grill', 'carnes', 'steak'], 'asado': ['grill', 'carnes', 'parrilla'],
          'colombiano': ['colombian', 'caribena', 'tipica'], 'colombiana': ['colombian', 'caribena'],
          'caribeno': ['caribena', 'colombian'], 'caribena': ['colombian'],
          'burger': ['fast_food', 'fastfood', 'hamburguesa'], 'hamburguesa': ['fast_food', 'fastfood', 'burger'],
          'hamburguesas': ['fast_food', 'fastfood', 'burger'],
          'argentino': ['grill', 'argentina', 'parrilla', 'carnes'], 'argentina': ['grill', 'parrilla'],
          'mediterraneo': ['mediterranean', 'middle_eastern', 'spanish', 'french', 'greek'],
          'mediterranea': ['mediterranean', 'middle_eastern', 'spanish', 'french', 'greek'],
        ...
        const scorePartner = (p: any): { score: number; hasDistinctive: boolean } => {
          ...
          const fields = [
            ...
            { val: Array.isArray(p.style_tags) ? p.style_tags.join(' ') : p.style_tags, weight: 3 },
