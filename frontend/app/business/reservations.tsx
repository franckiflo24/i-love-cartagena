                    ...
                    <TouchableOpacity
                      ...
                      onPress={() => {
                        const msg = encodeURIComponent(
                          `Hola AMO Travel, quiero activar el plan ${plan.name} ($${plan.price}) para mi negocio "${reservations[0]?.partner_name || ''}". ¿Cómo procedo?`,
                        );
...
const styles = StyleSheet.create({
  ...
  planCardHighlight: {
    borderColor: COLORS.primary,
    borderWidth: 2,
    backgroundColor: 'rgba(18,181,165,0.05)',
  },
