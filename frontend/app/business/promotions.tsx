...
const styles = StyleSheet.create({
  ...
  loopCard: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: 'rgba(18,181,165,0.10)', borderWidth: 1, borderColor: COLORS.primary, borderRadius: RADIUS.lg, padding: SPACING.md },
  ...
  count: { fontSize: 12, color: COLORS.primary, ...FONTS.bold, backgroundColor: 'rgba(18,181,165,0.15)', paddingHorizontal: 8, paddingVertical: 2, borderRadius: RADIUS.full, overflow: 'hidden' },
