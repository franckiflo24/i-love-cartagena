...
const styles = StyleSheet.create({
  ...
  trustBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, marginTop: SPACING.sm, paddingVertical: 9, borderRadius: RADIUS.md, borderWidth: 1, borderColor: 'rgba(245,11,27,0.4)', backgroundColor: 'rgba(245,11,27,0.08)' },
