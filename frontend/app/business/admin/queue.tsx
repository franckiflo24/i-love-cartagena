...
const styles = StyleSheet.create({
  ...
  tagManual: { backgroundColor: 'rgba(18,181,165,0.15)' },
  tagDispute: { backgroundColor: 'rgba(220,38,38,0.15)' },
  tagMedia: { backgroundColor: 'rgba(59,130,246,0.15)' },
  tagPrice: { backgroundColor: 'rgba(18,181,165,0.15)' },
  ...
  trustBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, marginTop: SPACING.sm, paddingVertical: 9, borderRadius: RADIUS.md, borderWidth: 1, borderColor: 'rgba(18,181,165,0.4)', backgroundColor: 'rgba(18,181,165,0.08)' },
