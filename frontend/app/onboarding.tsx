...
const styles = StyleSheet.create({
  ...
  glow: {
    ...
    backgroundColor: 'rgba(18,181,165,0.16)',
  ...
  lunaBubble: {
    flex: 1, backgroundColor: 'rgba(18,181,165,0.07)', borderColor: 'rgba(18,181,165,0.28)', borderWidth: 1,
  ...
  passportCard: {
    backgroundColor: 'rgba(255,255,255,0.035)', borderColor: 'rgba(18,181,165,0.22)', borderWidth: 1,
    borderRadius: 18, padding: 16, gap: 14,
  },
  passportSealRow: { flexDirection: 'row', gap: 12, alignItems: 'center' },
  dashedSeal: {
    width: 48, height: 48, borderRadius: 24, borderWidth: 1.5, borderColor: 'rgba(18,181,165,0.5)',
  ...
  stampHook: {
    ...
    backgroundColor: 'rgba(18,181,165,0.1)', borderRadius: 12, paddingVertical: 11, paddingHorizontal: 13,
  },
  ...
  qOption: {
    ...
    backgroundColor: 'rgba(255,255,255,0.04)', borderColor: 'rgba(18,181,165,0.2)', borderWidth: 1,
    borderRadius: 16, padding: 16,
  },
  qIcon: {
    width: 46, height: 46, borderRadius: 23, backgroundColor: 'rgba(18,181,165,0.12)',
