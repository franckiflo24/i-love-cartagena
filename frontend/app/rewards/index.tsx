...
> = {
  ...
  voyager: {
    label: 'Voyager',
    icon: 'boat',
    gradient: ['#92400E', '#12B5A5'],
    accent: '#12B5A5',
    border: 'rgba(18,181,165,0.5)',
  },
  elite: {
    label: 'Elite',
    icon: 'diamond',
...
const ACTION_ICONS: Record<string, { icon: keyof typeof Ionicons.glyphMap; color: string }> = {
  ...
  checkin:       { icon: 'location-outline',      color: '#12B5A5' },
            ...
            <TouchableOpacity
              ...
              onPress={async () => {
                ...
                try {
                  ...
                  await Share.share({
                    message: `Únete a AMO Life con mi código y ambos ganamos ${pts} puntos 🎁 Descubre lo mejor de Cartagena: ${link}`,
                  });
