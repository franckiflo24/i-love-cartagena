...
const styles = StyleSheet.create({
  ...
  scamCard: { flexDirection: 'row', gap: 12, marginHorizontal: SPACING.lg, marginBottom: SPACING.sm, padding: SPACING.md, backgroundColor: COLORS.surface, borderRadius: RADIUS.lg, borderWidth: 1, borderColor: 'rgba(212,175,55,0.3)' },
  ...
  zoneChip: { backgroundColor: 'rgba(212,175,55,0.10)', borderColor: 'rgba(212,175,55,0.4)', borderWidth: 1, borderRadius: RADIUS.full, paddingHorizontal: 12, paddingVertical: 5 },
