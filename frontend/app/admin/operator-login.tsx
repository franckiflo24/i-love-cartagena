...
const styles = StyleSheet.create({
  ...
  crown: { width: 80, height: 80, borderRadius: 40, backgroundColor: 'rgba(18,181,165,0.12)', borderWidth: 1, borderColor: 'rgba(18,181,165,0.4)', alignItems: 'center', justifyContent: 'center' },
