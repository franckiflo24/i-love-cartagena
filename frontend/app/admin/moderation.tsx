...
const styles = StyleSheet.create({
  ...
  aiHero: { flexDirection: 'row', alignItems: 'center', gap: SPACING.md, padding: SPACING.md, margin: SPACING.lg, marginBottom: SPACING.sm, backgroundColor: 'rgba(18,181,165,0.1)', borderRadius: RADIUS.lg, borderWidth: 1, borderColor: 'rgba(18,181,165,0.4)' },
  aiIcon: { width: 48, height: 48, borderRadius: 24, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(18,181,165,0.2)' },
  ...
  aiBox: { flexDirection: 'row', gap: SPACING.sm, margin: SPACING.md, padding: SPACING.sm, backgroundColor: 'rgba(18,181,165,0.08)', borderRadius: RADIUS.md, borderWidth: 1, borderColor: 'rgba(18,181,165,0.3)' },
