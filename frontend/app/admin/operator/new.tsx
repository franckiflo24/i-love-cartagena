...
import { View, Text, StyleSheet, ScrollView, TextInput, TouchableOpacity, KeyboardAvoidingView, Platform, Share, ActivityIndicator, Clipboard } from 'react-native';
...
const TIERS = [
  ...
  { id: 'premium',  label: 'Premium', color: '#12B5A5' },
