...
const styles = StyleSheet.create({
  ...
  questCard: { flexDirection: 'row', alignItems: 'center', gap: 12, marginHorizontal: SPACING.lg, marginBottom: SPACING.md, padding: SPACING.md, backgroundColor: 'rgba(212,175,55,0.07)', borderRadius: RADIUS.lg, borderWidth: 1, borderColor: 'rgba(212,175,55,0.35)' },
  ...
  trailMeta: { fontSize: 11, color: 'rgba(212,175,55,0.9)', ...FONTS.semibold, marginTop: 4 },
  ...
  stopDist: { fontSize: 10, color: 'rgba(212,175,55,0.9)', ...FONTS.semibold, marginTop: 1 },
  ...
  doneCodeBox: { alignItems: 'center', gap: 3, padding: SPACING.sm, backgroundColor: 'rgba(212,175,55,0.07)', borderRadius: RADIUS.md, borderWidth: 1, borderColor: 'rgba(212,175,55,0.3)' },
