...
const styles = StyleSheet.create({
  ...
  personalizationBanner: {
    ...
    borderWidth: 1,
    borderColor: 'rgba(245,11,27,0.25)',
  },
  personalizationText: {
    fontSize: 12,
    color: COLORS.primary,
  ...
  pricePillPaid: {
    backgroundColor: 'rgba(245,11,27,0.85)',
  },
  pricePillText: {
    fontSize: 10,
    color: COLORS.white,
  ...
  footerBtn: {
    ...
    borderWidth: 1,
    borderColor: 'rgba(245,11,27,0.35)',
    backgroundColor: 'rgba(245,11,27,0.08)',
  },
  footerBtnText: {
    fontSize: 14,
    color: COLORS.primary,
  ...
  nbTag: { backgroundColor: 'rgba(245,11,27,0.12)', borderRadius: RADIUS.full, paddingHorizontal: 8, paddingVertical: 3, borderWidth: 1, borderColor: 'rgba(245,11,27,0.25)' },
  ...
  nbModalTag: { backgroundColor: 'rgba(245,11,27,0.12)', borderRadius: RADIUS.full, paddingHorizontal: 10, paddingVertical: 5, borderWidth: 1, borderColor: 'rgba(245,11,27,0.25)' },
