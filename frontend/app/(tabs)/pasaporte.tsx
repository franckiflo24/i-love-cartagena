...
export default function PasaporteScreen() {
  ...
  const onGroupShare = useCallback(async (g: GroupStanding) => {
    ...
    const msg = `${tr('Únete a')} ${label} ${tr('en AMO Life')} 🛂 — ${tr('comparemos pasaportes')}.\n${tr('Código')}: ${g.code}\n${g.share_url}`;
    try {
...
const styles = StyleSheet.create({
  ...
  cover: { marginHorizontal: SPACING.lg, marginBottom: SPACING.sm, padding: SPACING.md, backgroundColor: 'rgba(18,181,165,0.07)', borderRadius: RADIUS.xl, borderWidth: 1.5, borderColor: 'rgba(18,181,165,0.5)', gap: 12 },
  ...
  groupCodePill: { flexDirection: 'row', alignItems: 'center', gap: 7, backgroundColor: 'rgba(18,181,165,0.10)', borderRadius: RADIUS.md, borderWidth: 1, borderColor: 'rgba(18,181,165,0.4)', borderStyle: 'dashed', paddingHorizontal: 12, paddingVertical: 8, marginBottom: 2 },
  ...
  groupRowMe: { backgroundColor: 'rgba(18,181,165,0.08)' },
  ...
  tileDist: { fontSize: 9, color: 'rgba(18,181,165,0.8)', ...FONTS.medium },
