...
const styles = StyleSheet.create({
  ...
  headerTitle: { ...TYPE.title2, color: COLORS.textMain, marginTop: 2 },
  ...
  heroBannerTitle: { ...TYPE.title2, color: COLORS.textMain, marginTop: 4 },
  ...
  heroTitle: { ...TYPE.title1, color: COLORS.textMain, marginTop: SPACING.xs },
  ...
  partnersCtaTitle: { ...TYPE.title3, color: COLORS.textMain },
