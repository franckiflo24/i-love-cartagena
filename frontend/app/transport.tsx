...
export default function TransportScreen() {
  ...
  const openWhatsAppBooking = (route: any) => {
    ...
    const msg = encodeURIComponent(
      `Hola! Quiero reservar transporte via *AMO Life* 🌴\n\n`
      + `Ruta: *${routeName}*\n`
      + `Precio referencia: ${priceText}\n`
      + `Pasajeros: 1\n\n`
      + `¿Disponibilidad?\n\n---\n\n`
      + `Hi! I'd like to book transport via *AMO Life* 🌴\n\n`
      + `Route: *${routeName}*\n`
      + `Ref. price: ${priceText}\n`
      + `Passengers: 1\n\n`
      + `Availability?`
...
const styles = StyleSheet.create({
  ...
  iconWrap: { width: 44, height: 44, borderRadius: RADIUS.md, backgroundColor: 'rgba(18,181,165, 0.15)', alignItems: 'center', justifyContent: 'center' },
  ...
  scheduleCount: {
    backgroundColor: 'rgba(18,181,165,0.18)', borderRadius: 999,
  ...
  timePill: {
    backgroundColor: 'rgba(18,181,165,0.15)', paddingHorizontal: 10, paddingVertical: 4,
  ...
  routeDash: { flex: 1, height: 1, backgroundColor: 'rgba(18,181,165,0.35)' },
  durationChip: {
  ...
  faresIconWrap: { width: 44, height: 44, borderRadius: RADIUS.md, backgroundColor: 'rgba(18,181,165,0.15)', alignItems: 'center', justifyContent: 'center' },
  ...
  fareZonePill: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: 'rgba(18,181,165,0.12)', borderRadius: RADIUS.full, paddingHorizontal: 8, paddingVertical: 3 },
