  ...
  return (
    ...
    <Animated.View style={[StyleSheet.absoluteFill, styles.backdrop, { opacity: backdrop }]}>
      <Animated.View style={[styles.stamp, { opacity: stampOpacity, transform: [{ scale: stampScale }, { rotate: '-7deg' }] }]}>
        <Text style={styles.stampArc}>AMO LIFE</Text>
      ...
      <Animated.View style={[styles.details, { opacity: detailsOpacity }]}>
        ...
        {onShare ? (
          <TouchableOpacity
            style={[styles.cta, { backgroundColor: '#12B5A5' }]}
            onPress={onShare}
            activeOpacity={0.85}
          >
...
const styles = StyleSheet.create({
  ...
  stamp: {
    ...
    backgroundColor: 'rgba(18,181,165,0.06)', padding: 18,
  },
  ...
  rankBanner: {
    ...
    backgroundColor: 'rgba(18,181,165,0.14)', borderRadius: RADIUS.lg, borderWidth: 1,
  ...
  medalRow: {
    ...
    borderColor: 'rgba(18,181,165,0.4)', padding: 12,
  },
