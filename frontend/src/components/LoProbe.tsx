...
const styles = StyleSheet.create({
  box: { marginTop: SPACING.md, backgroundColor: 'rgba(212,175,55,0.06)', borderRadius: RADIUS.lg, borderWidth: 1, borderColor: 'rgba(212,175,55,0.3)', padding: SPACING.md, gap: 8 },
  ...
  rowDone: { borderColor: 'rgba(212,175,55,0.5)' },
  ...
  doneChip: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: 'rgba(212,175,55,0.85)', borderRadius: RADIUS.full, paddingHorizontal: 10, paddingVertical: 5 },
