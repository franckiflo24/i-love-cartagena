...
const styles = StyleSheet.create({
  ...
  sheet: { backgroundColor: COLORS.surface, borderTopLeftRadius: 24, borderTopRightRadius: 24, padding: SPACING.lg, paddingBottom: Platform.OS === 'ios' ? 36 : SPACING.lg, gap: 12, borderTopWidth: 1, borderColor: 'rgba(18,181,165,0.3)' },
  ...
  baseCard: { flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: 'rgba(18,181,165,0.10)', borderRadius: RADIUS.lg, borderWidth: 1, borderColor: 'rgba(18,181,165,0.4)', padding: 14 },
  ...
  notice: { backgroundColor: 'rgba(18,181,165,0.12)', borderRadius: RADIUS.md, borderWidth: 1, borderColor: 'rgba(18,181,165,0.4)', padding: 10 },
