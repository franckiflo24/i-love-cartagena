...
const styles = StyleSheet.create({
  wrap: {
    ...
    borderWidth: 1, borderColor: 'rgba(18,181,165,0.25)', backgroundColor: COLORS.surface,
  },
  blurLayer: { width: '100%' },
  scrim: {
  ...
  seal: {
    width: 44, height: 44, borderRadius: 22, borderWidth: 1.5, borderColor: 'rgba(18,181,165,0.5)',
