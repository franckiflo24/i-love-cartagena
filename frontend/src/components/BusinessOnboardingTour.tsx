...
const styles = StyleSheet.create({
  ...
  card: {
    ...
    paddingHorizontal: SPACING.xl, paddingBottom: SPACING.lg, borderWidth: 1, borderColor: 'rgba(18,181,165,0.28)',
    overflow: 'hidden', alignItems: 'center',
  },
  glow: {
    position: 'absolute', top: -90, alignSelf: 'center', width: 320, height: 320, borderRadius: 160,
    backgroundColor: 'rgba(18,181,165,0.16)', ...(Platform.OS === 'web' ? ({ filter: 'blur(70px)' } as any) : {}),
  },
  ...
  iconWrap: {
    ...
    backgroundColor: 'rgba(18,181,165,0.14)', borderWidth: 1.5, borderColor: 'rgba(18,181,165,0.5)', marginBottom: 16,
  },
  ...
  tip: {
    flexDirection: 'row', gap: 9, alignItems: 'flex-start', marginTop: 16, backgroundColor: 'rgba(18,181,165,0.09)',
    borderWidth: 1, borderColor: 'rgba(18,181,165,0.24)', borderRadius: 12, padding: 12,
  },
