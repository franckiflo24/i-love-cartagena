...
async def seed_database():
    ...
    events = [
        ...
        {"event_id":"evt_014","title":"Sunset Closing","description":"Ceremonia de cierre con DJ set y performance artístico en la muralla. El atardecer final de Viva Cartagena.","date":"2026-01-16","start_time":"17:00","end_time":"21:00","venue_id":"ven_001","venue_name":"La Muralla","type":"sunset","is_free":True,"price":0,"image_url":IMG_CLOSING,"booking_link":"","capacity":1000,"tags":["closing","sunset","free","special"],"location":{"lat":10.4236,"lng":-75.5483},"featured":True},
    ...
    transport_data = [
        ...
        ],"departure_point":"Muelle Turístico de la Bodeguita","departure_location":{"lat":10.4200,"lng":-75.5500},"price":"90,000 COP ida / 160,000 COP ida y vuelta","notes":"Llevar protector solar. Regreso última lancha 16:00.","partner_name":"Transporte Oficial Viva Cartagena","last_return":"16:00"},
        ...
        ],"departure_point":"Muelle Turístico de la Bodeguita","departure_location":{"lat":10.4200,"lng":-75.5500},"price":"70,000 COP ida / 120,000 COP ida y vuelta","notes":"Regreso última lancha 17:00. Incluye chaleco salvavidas.","partner_name":"Lanchas Viva Cartagena","last_return":"17:00"},
        ...
        ],"departure_point":"Aeropuerto Rafael Núñez","departure_location":{"lat":10.4427,"lng":-75.5130},"price":"25,000 COP","notes":"Reserva previa recomendada. Duración aprox. 20 min.","partner_name":"Viva Cartagena Transfer","last_return":"22:00"},
    ]

    notifications = [
        {"notification_id":"ntf_001","user_id":None,"title":"Bienvenido a Viva Cartagena","message":"Viva Cartagena te da la bienvenida. Explora la agenda y planifica tu semana perfecta.","type":"general","event_id":"","is_read":False,"created_at":datetime.now(timezone.utc).isoformat()},
