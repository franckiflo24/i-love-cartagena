...
async def startup():
    ...
    # ── Migration: Pasa día (Day Pass) partners ──
    DAYPASS_DEMO = [
        # Beach club Tierra Bomba
        {
            "partner_id": "ptr_dp_001", "subcategory": "beach_tierrabomba",
            "name": "Bora Bora Beach Club",
            "description": "Beach club exclusivo en Tierra Bomba. Day pass con almuerzo, drinks ilimitados y traslado en lancha.",
            "category": "daypass", "tier": "elite",
            "image_url": "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",
            "location": {"lat": 10.3650, "lng": -75.5780},
            "address": "Tierra Bomba, Cartagena",
            "booking_link": "https://boraboracartagena.com",
            "price_range": "$$$",
            "experience": "Day pass + lancha + almuerzo + open bar",
            "is_certified": True, "instagram": "@boraboracartagena",
        },
        {
            "partner_id": "ptr_dp_002", "subcategory": "beach_tierrabomba",
            "name": "Fenix Beach Cartagena",
            "description": "Beach club premium en Tierra Bomba con pool deck, restaurante mediterráneo y DJ sets al atardecer.",
            "category": "daypass", "tier": "premium",
            "image_url": "https://images.unsplash.com/photo-1519046904884-53103b34b206?w=800&h=600&fit=crop",
            "location": {"lat": 10.3625, "lng": -75.5810},
            "address": "Tierra Bomba, Cartagena",
            "booking_link": "https://fenixbeach.com",
            "price_range": "$$$",
            "experience": "Pool deck, almuerzo mediterráneo, DJ sunset",
            "is_certified": True, "instagram": "@fenixbeach",
        },
        # Beach club Island (Rosario / Barú)
        {
            "partner_id": "ptr_dp_003", "subcategory": "beach_island",
            "name": "Blue Apple Beach (Tierra Bomba)",
            "description": "Day pass con experiencia de bienestar, almuerzo gourmet y acceso a piscina infinita frente al mar.",
            "category": "daypass", "tier": "elite",
            "image_url": "https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=800&h=600&fit=crop",
            "location": {"lat": 10.1780, "lng": -75.5800},
            "address": "Isla del Encanto, Islas del Rosario",
            "booking_link": "https://blueapple.co",
            "price_range": "$$$$",
            "experience": "Day pass wellness + almuerzo + piscina infinita",
            "is_certified": True, "instagram": "@blueapplebeach",
        },
        {
            "partner_id": "ptr_dp_004", "subcategory": "beach_island",
            "name": "Isla Barú Beach Club",
            "description": "All-inclusive day pass en Playa Blanca, Barú. Almuerzo, snorkel, kayak y traslado en lancha.",
            "category": "daypass", "tier": "popular",
            "image_url": "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",
            "location": {"lat": 10.1817, "lng": -75.5847},
            "address": "Playa Blanca, Isla Barú",
            "booking_link": "https://barubeach.com",
            "price_range": "$$$",
            "experience": "Day pass all-inclusive + snorkel + kayak",
            "is_certified": True, "instagram": "@barubeachclub",
        },
        # Piscina hotel
        {
            "partner_id": "ptr_dp_005", "subcategory": "pool_hotel",
            "name": "Sofitel Santa Clara — Pool Day Pass",
            "description": "Acceso por el día a la piscina del Sofitel Legend Santa Clara. Incluye toalla, tumbona y crédito de consumo.",
            "category": "daypass", "tier": "elite",
            "image_url": "https://images.unsplash.com/photo-1540541338287-41700207dee6?w=800&h=600&fit=crop",
            "location": {"lat": 10.4255, "lng": -75.5482},
            "address": "Sofitel Santa Clara, Centro Histórico",
            "booking_link": "https://sofitel-legend-santaclara.com",
            "price_range": "$$$$",
            "experience": "Day pass piscina + crédito consumo + tumbona",
            "is_certified": True, "instagram": "@sofitelsantaclara",
        },
        {
            "partner_id": "ptr_dp_006", "subcategory": "pool_hotel",
            "name": "Hotel Caribe — Pool Day",
            "description": "Day pass clásico en una de las piscinas más icónicas de Bocagrande, con almuerzo a la carta.",
            "category": "daypass", "tier": "premium",
            "image_url": "https://images.unsplash.com/photo-1571003123894-1f0594d2b5d9?w=800&h=600&fit=crop",
            "location": {"lat": 10.4059, "lng": -75.5556},
            "address": "Bocagrande, Cartagena",
            "booking_link": "https://hotelcaribe.com",
            "price_range": "$$$",
            "experience": "Piscina histórica, almuerzo a la carta",
            "is_certified": True, "instagram": "@hotelcaribe",
        },
        # Boat tour
        {
            "partner_id": "ptr_dp_007", "subcategory": "boat_tour",
            "name": "Yacht Day Tour — Islas del Rosario",
            "description": "Tour en yate privado por las Islas del Rosario. Snorkel, almuerzo a bordo y open bar para 12 personas.",
            "category": "daypass", "tier": "elite",
            "image_url": "https://images.unsplash.com/photo-1605281317010-fe5ffe798166?w=800&h=600&fit=crop",
            "location": {"lat": 10.1800, "lng": -75.5800},
            "address": "Salida desde Muelle La Bodeguita",
            "booking_link": "https://boatingcartagena.com",
            "price_range": "$$$$",
            "experience": "Yate privado, snorkel, almuerzo + open bar",
            "is_certified": True, "instagram": "@boatingcartagena",
        },
        {
            "partner_id": "ptr_dp_008", "subcategory": "boat_tour",
            "name": "Catamaran Sunset Cruise",
            "description": "Tour en catamarán por las islas con paradas para snorkel y almuerzo. Experiencia compartida.",
            "category": "daypass", "tier": "popular",
            "image_url": "https://images.unsplash.com/photo-1502635385003-ee1e6a1a742d?w=800&h=600&fit=crop",
            "location": {"lat": 10.4180, "lng": -75.5520},
            "address": "Salida desde Muelle La Bodeguita",
            "booking_link": "https://catamarancartagena.com",
            "price_range": "$$",
            "experience": "Catamarán, snorkel, almuerzo, parada en isla",
            "is_certified": True, "instagram": "@catamarancartagena",
        },
    ]
    for d in DAYPASS_DEMO:
        await db.partners.update_one({"partner_id": d["partner_id"]}, {"$set": d}, upsert=True)

    # ── Migration: Sunset Experience partners ──
    SUNSET_DEMO = [
        # Roof top
        {
            "partner_id": "ptr_ss_001", "subcategory": "rooftop",
            "name": "Movich Rooftop",
            "description": "Roof top icónico del Movich Hotel con vista 360° a las murallas y la bahía. Cócteles de autor al atardecer.",
            "category": "sunset", "tier": "premium",
            "image_url": "https://images.unsplash.com/photo-1519214605650-76a613ee3245?w=800&h=600&fit=crop",
            "location": {"lat": 10.4256, "lng": -75.5478},
            "address": "Movich Hotel, Centro Histórico",
            "booking_link": "https://movichhotels.com",
            "price_range": "$$$",
            "experience": "Sunset 360°, cócteles de autor, DJ chill",
            "is_certified": True, "instagram": "@movichcartagena",
        },
        {
            "partner_id": "ptr_ss_002", "subcategory": "rooftop",
            "name": "Townhouse Rooftop",
            "description": "Terraza boutique en Getsemaní con piscina, food truck gourmet y la mejor música electrónica del centro.",
            "category": "sunset", "tier": "premium",
            "image_url": "https://images.unsplash.com/photo-1540541338287-41700207dee6?w=800&h=600&fit=crop",
            "location": {"lat": 10.4198, "lng": -75.5468},
            "address": "Townhouse Hotel, Getsemaní",
            "booking_link": "https://townhousehotel.com",
            "price_range": "$$$",
            "experience": "Pool, food truck, DJ electrónico",
            "is_certified": True, "instagram": "@townhousecartagena",
        },
        {
            "partner_id": "ptr_ss_003", "subcategory": "rooftop",
            "name": "Café del Mar — Las Murallas",
            "description": "El sunset más famoso de Cartagena. Sobre las murallas, mirando al Caribe. Cócteles y música chill.",
            "category": "sunset", "tier": "elite",
            "image_url": "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",
            "location": {"lat": 10.4232, "lng": -75.5510},
            "address": "Baluarte de Santo Domingo, Centro",
            "booking_link": "https://cafedelmarcartagena.com",
            "price_range": "$$$",
            "experience": "Sunset sobre las murallas, mojitos, música chill",
            "is_certified": True, "instagram": "@cafedelmarcartagena",
        },
        # Boat experience
        {
            "partner_id": "ptr_ss_004", "subcategory": "boat_experience",
            "name": "Sunset Sailing Cartagena",
            "description": "Salida en velero al atardecer por la bahía. Champagne, snacks y vistas al skyline iluminado.",
            "category": "sunset", "tier": "elite",
            ...
            "price_range": "$$$$",
            "experience": "Velero privado, champagne sunset, snacks gourmet",
            "is_certified": True, "instagram": "@sunsetsailingco",
        },
        {
            "partner_id": "ptr_ss_005", "subcategory": "boat_experience",
            "name": "Caribbean Sunset Cruise",
            "description": "Tour grupal en yate por la bahía al atardecer. Open bar de cocktails caribeños y música en vivo.",
            "category": "sunset", "tier": "premium",
            "image_url": "https://images.unsplash.com/photo-1605281317010-fe5ffe798166?w=800&h=600&fit=crop",
            "location": {"lat": 10.4188, "lng": -75.5523},
            "address": "Muelle La Bodeguita",
            "booking_link": "https://caribbeancruise.co",
            "price_range": "$$$",
            "experience": "Yate compartido, open bar, música en vivo, sunset",
            "is_certified": True, "instagram": "@caribbeancruiseco",
        },
    ]
    for s in SUNSET_DEMO:
        await db.partners.update_one({"partner_id": s["partner_id"]}, {"$set": s}, upsert=True)
