...
HOTEL_RAW: List[str] = [
    ...
    "Casa Quero",
    "Casa del Curato",
    "Hotel Boutique Casa Noble",
    "Hotel Portal de San Diego",
    "Hotel 3 Banderas",
    "Hotel Boutique Casa Fernandez",
    "Hotel Boutique Casa del Gobernador",
    "Casa Venita Boutique",
    "OSH Hotel Cartagena",
    ...
    "Radisson Ocean Pavillion Hotel",
    "Las Américas Torre del Mar",
    "Las Américas Casa de Playa",
    "Meliá Cartagena Karmairi",
    "Karmairi Cartagena Spa",
    "Hotel Summer Ocean Front",
    "Hotel Vistamarina Casa Hotel",
    "Hotel Boutique Casa del Coliseo Premium",
    "Hotel Boutique Casa Baloco",
    "Casa del Curato Luxury",
    "Casa Esther Cartagena",
    "Casa Del Tejadillo Boutique Suites",
    "Hotel Boutique Casa Helda",
    "Casa Fernández Madrid",
    "Casa Arte Hotel Boutique",
    "Casa del Cabrero B&G",
    "Hotel Boutique Casa del Ángel",
    "Casa India Catalina Deluxe",
    "Hotel Boutique Casa Alegre",
    "Hotel Boutique Casa Mar",
    "Hotel Boutique Casa Relax Deluxe",
    "Hotel Boutique Casa del Parque",
    "Hotel Boutique Casa Abril",
    "Hotel Boutique Casa Mara Premium",
    "Hotel Boutique Casa Lucy",
    "Hotel Boutique Casa Serrezuela",
    "Hotel Boutique Casa Real del Cabrero",
    "Hotel Boutique Casa Gloria Premium",
    "Hotel Boutique Casa Blue Garden",
    "Hotel Boutique Casa del Virrey Premium",
    "Hotel Boutique Casa Eden",
    "Hotel Boutique Casa del Puerto Luxury",
    "Hotel Boutique Casa Marqués del Pedregal",
    "Hotel Boutique Casa de Playa Cartagena",
    "Hotel Boutique Casa Coralina Beach",
    "Hotel Boutique Casa Bahía Suites",
    "Hotel Boutique Casa Marina Beach",
    "Hotel Boutique Casa Horizonte",
    "Hotel Boutique Casa del Faro",
    "Hotel Boutique Casa Riviera",
    "Hotel Boutique Casa del Sol Premium",
    "Hotel Boutique Casa Ocean Luxury",
    "Hotel Boutique Casa Platinum Beach",
    "Hotel Boutique Casa Elite Bocagrande",
    "Hotel Boutique Casa Vista Mar",
    "Hotel Boutique Casa Infinity Suites Cartagena",
    "Hotel Boutique Casa Palma Beach",
    "Hotel Boutique Casa Sunset Luxury",
    "Hotel Boutique Casa Azul del Mar",
    "Hotel Boutique Casa Crystal Lagoon",
    "Hotel Boutique Casa Grand Bay",
    "Hotel Boutique Casa Coral Vista",
    "Hotel Boutique Casa Diamond Beach",
    "Hotel Boutique Casa White Sand Cartagena",
    "Hotel Boutique Casa Royal Beach Club",
    "Hotel Boutique Casa Tropical Elite",
    "Hotel Boutique Casa Signature Beach",
    "Hotel Boutique Casa Marina Royal",
    "Hotel Boutique Casa Imperial Beach",
    "Hotel Boutique Casa Golden Bay Cartagena",
    "Hotel Boutique Casa Ocean Front",
    "Hotel Boutique Casa Paradise Bay",
    "Hotel Boutique Casa Seaside Luxury",
    "Hotel Boutique Casa Blue Coast",
    "Hotel Boutique Casa Riviera Elite",
    "Hotel Boutique Casa Premium Ocean",
    "Hotel Boutique Casa Coral Palace",
    "Hotel Boutique Casa Infinity Bay",
    "Hotel Boutique Casa Diamond Elite",
    "Hotel Boutique Casa Grand Ocean",
    "Hotel Boutique Casa White Pearl Cartagena",
    "Hotel Boutique Casa Sunset Bay Cartagena",
    "Hotel Boutique Casa Horizon Ocean",
    "Hotel Boutique Casa Marina Infinity",
    "Hotel Boutique Casa Royal Infinity",
    "Hotel Boutique Casa Ocean Signature",
    "Hotel Boutique Casa Tropical Bay Cartagena",
    "Hotel Boutique Casa Imperial Ocean",
    "Hotel Boutique Casa Platinum Coast",
    "Hotel Boutique Casa Elite Ocean",
    "Hotel Boutique Casa Coral Suites Cartagena",
    "Hotel Boutique Casa Golden Coast Cartagena",
    "Hotel Boutique Casa Blue Horizon Cartagena",
    "Hotel Boutique Casa Ocean Breeze Cartagena",
    "Hotel Boutique Casa Paradise Ocean",
    "Hotel Boutique Casa Royal Coast",
    "Hotel Boutique Casa Infinity Luxury Suites",
    "Hotel Casa Tere",
    ...
    "Hotel Boutique Casa Gloria Getsemani",
    "Hotel Boutique Casa Isabel Getsemani",
    "Hotel Boutique Casa Jaguar",
    "Hotel Boutique Casa Minerva",
    "Hotel Boutique Casa Venecia",
    "Hotel Boutique Casa Lyon",
    "Hotel Boutique Casa Macia",
    "Hotel Boutique Casa del Reloj",
    "Hotel Boutique Casa del Jardin",
]
